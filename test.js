  ...
  t.test('parse sleeping-on-the-road', t => {
    loadSongsheet('./sleeping-on-the-road.txt')
      .then(song => {
        ...
        t.equal(structure.get(0).get('lyricLineCharacters').get(0).get(0).get('chord').get('root'), 'G')
  ...
  t.test('parse riot-on-a-screen', t => {
    loadSongsheet('./riot-on-a-screen.txt')
      .then(song => {
        ...
        t.equal(structure.get(0).get('lyricLineCharacters').get(0).get(0).get('chord').get('root'), 'D')
        t.equal(structure.get(0).get('lyricLineCharacters').get(0).get(1).get('chord'), undefined)
  ...
  t.test('parse song-of-myself', t => {
    loadSongsheet('./song-of-myself.txt')
      .then(song => {
        ...
        t.equal(structure.get(0).get('lyricLineCharacters').get(0).get(7).get('chord').get('root'), 'G')
        t.equal(structure.get(0).get('lyricLineCharacters').get(0).get(35).get('chord').get('root'), 'A')
        t.equal(structure.get(0).get('lyricLineCharacters').get(0).get(35).get('chord').get('type'), 'm')
