  ...
  t.test('parse sleeping-on-the-road', t => {
    loadSongsheet('./sleeping-on-the-road.txt')
      .then((song) => {
        ...
        t.deepEqual(structure.map(s => !!s.get('chords')).toArray(), [ true, true, true, true, true, true, true, true, true, false, true ])
        t.deepEqual(structure.map(s => !!s.get('lyrics')).toArray(), [ true, true, true, true, true, true, true, true, true, false, true ])
  ...
  t.test('parse riot-on-a-screen', t => {
    loadSongsheet('./riot-on-a-screen.txt')
      .then((song) => {
        ...
        t.deepEqual(structure.map(s => !!s.get('chords')).toArray(), [ true, true, false, true, true, true, false, true, true, false ])
        t.deepEqual(structure.map(s => !!s.get('lyrics')).toArray(), [ true, true, false, true, true, true, false, true, true, false ])
  ...
  t.test('parse spent-some-time-in-buffalo', t => {
    loadSongsheet('./spent-some-time-in-buffalo.txt')
      .then((song) => {
        ...
        t.deepEqual(structure.map(s => !!s.get('chords')).toArray(), [ true, true, true, true, true, true, true, false, true, true ])
        t.deepEqual(structure.map(s => !!s.get('lyrics')).toArray(), [ true, true, true, true, true, true, true, false, true, true ])
